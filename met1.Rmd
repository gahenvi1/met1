...
ggplot() + 
  ...
  scale_fill_viridis(option = "D", direction = -1, name = "Número de estudantes") +
  theme_minimal()
...
dist_freq <- table(cut(banco$NOTA_LP, breaks = qtd_classes, include.lowest = T))
rownames(dist_freq) <- labels
